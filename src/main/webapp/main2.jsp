...
<body>
							...
							<tr>
									...
									%>
										 <td>
											 ...
											 <select name="jobs" id="jobs" style="height:45px; width:100%;">
											 ...
											 <div style="float:left">
											 <textarea class="textarea" id="bbsContent" required style="height:180px;width:185%; border:none; " placeholder="업무내용" name="bbsContent"></textarea>
											 </div>
										 </td>
										 <td><input type="date" max="9999-12-31" style="height:45px; width:auto;" id="bbsStart" class="form-control" placeholder="접수일" name="start_add" ></td>
										 <td><input type="date" max="9999-12-31" style="height:45px; width:auto;" id="bbsTarget" class="form-control" placeholder="완료목표일" name="target_add" oninput="this.value = this.value
												.replace(/[^0-9./.\s.%.-]/g, '')
												.replace(/(\..*)\./g, '$1');"></td>		
									...
									<tr>
										 <td colspan="5"><button type="button" style="margin-bottom:5px; margin-top:5px; margin-left:15px" onclick="addRow()" class="btn btn-primary"> + </button>
										 			</td>	
									</tr>
	...
	<script>
		function addRow() {
			const table = document.getElementById("bbs_table");
